...
/* */
#ifndef _SHACL2CODE_TEST_CONTEXT_PROPERTYVALUE_HPP
#define _SHACL2CODE_TEST_CONTEXT_PROPERTYVALUE_HPP
...
class PropertyValue : public PropertyValueCommon {
   ...
   public:
    ...
    /// @copydoc ::test_context::PropertyValueCommon::encode()
    ...
    /// @copydoc ::test_context::PropertyValueCommon::decode()
    ...
    /// @copydoc ::test_context::PropertyValueCommon::elide()
    bool elide() const override { return !isSet(); }

    /// @copydoc ::test_context::PropertyValueCommon::link()
    ...
    /// @copydoc ::test_context::PropertyValueCommon::walk()
    ...
    /// @copydoc ::test_context::PropertyValueCommon::check()
 ...
 * ::test_context::ListPropertyValue::insert(),
 * ::test_context::ListPropertyValue::push_back(),
 * ::test_context::ListPropertyValue::add()
 * will be validated at the time of insertion. However, if an item is modified
 * via an iterator, ::test_context::ListPropertyValue::at() or
 * ::test_context::ListPropertyValue::operator[],
 * Its new value will not be validated when it is changed. Validation can be
 * performed manually using ::test_context::ListPropertyValue::validateValue().
...
/* */
/* */
#endif // _SHACL2CODE_TEST_CONTEXT_PROPERTYVALUE_HPP
/* */
