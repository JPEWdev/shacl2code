...
// clang-format off
#ifndef _SHACL2CODE_TEST_JSONLD_HPP
#define _SHACL2CODE_TEST_JSONLD_HPP
// clang-format on
...
class EXPORT JSONLDObjectEncoder : public ObjectEncoder {
   public:
    ...
    /// @copydoc ::test::ObjectEncoder::writeProperty()
...
class EXPORT JSONLDListEncoder : public ListEncoder {
   public:
    ...
    /// @copydoc ::test::ListEncoder::writeItem()
...
class EXPORT JSONLDObjectDecoder : public ObjectDecoder {
   public:
    ...
    /// @copydoc ::test::ObjectDecoder::readType()
    std::optional<std::string> readType() override;

    /// @copydoc ::test::ObjectDecoder::readProperties()
...
class EXPORT JSONLDListDecoder : public ListDecoder {
   public:
    ...
    /// @copydoc ::test::ListDecoder::readItems()
...
#endif  // _SHACL2CODE_TEST_JSONLD_HPP
