...
/* */
#ifndef _SHACL2CODE_TEST_TYPE_HPP
#define _SHACL2CODE_TEST_TYPE_HPP
 ...
 * SHACL2CODE_TEST_CLASS macro takes care of it
 *
...
class SHACLType : public TypeBase {
   ...
   public:
    ...
    /// @copydoc ::test::TypeBase::getIDAlias()
    ...
    /// @copydoc ::test::TypeBase::getNodeKind()
    ...
    /// @copydoc ::test::TypeBase::isExtensible()
    ...
    /// @copydoc ::test::TypeBase::isAbstract()
    bool isAbstract() const override { return ABSTRACT; }

    /// @copydoc ::test::TypeBase::isSubClassOf()
   ...
   protected:
    ...
    /// @copydoc ::test::TypeBase::createExtensible()
...
/* */
/* */
#endif // _SHACL2CODE_TEST_TYPE_HPP
/* */
